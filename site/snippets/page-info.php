...
<div>
    <div class="cards-dates" style="display: flex; width: 100%; flex-direction: row; justify-content: space-between; flex-wrap:wrap;">
        <?php if($item->appuntamenti()->isNotEmpty()): ?>
            ...
            ?>
            <div class="appuntamento" style="display: flex; min-width: 100%; flex-direction: row; justify-content: center; flex-wrap:nowrap;">
                <span style="width: fit-content; min-width: fit-content; text-transform: uppercase; margin-right: 15px;" class="">
                    <?php 
    ...
    <?php if ($item->deadline()->isNotEmpty() && strtotime($item->deadline()) >= strtotime('today')): ?>
        ...
        <div class="cards-dates" style="display: flex; width: 100%; justify-content: center; flex-wrap:wrap; ">
            ...
            <span id="deadline" class="center" style="width: fit-content; display: flex; justify-content: space-between;" class="time">
                <strong style="min-width: fit-content;">Iscrizioni entro il <u><?= $formatter->format($deadline->toDate()) ?></u></strong>
            </span>
        </div>
    <?php else: ?>
    <?php endif; ?>
