...
const DEFAULT_CONTENT = [
    'title' => '<h1 style="margin-bottom: 15px; font-size:px"><strong>Cookies</strong></h1>',
    'text' => 'In questo sito utilizziamo i cookies per migliorare la tua esperienza di navigazione e offrirti un servizio migliore. <br><br>Per maggiori dettagli leggi la (link: privacy-policy text: privacy policy)',
